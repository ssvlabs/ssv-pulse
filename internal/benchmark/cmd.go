...
func addFlags(cobraCMD *cobra.Command) {
	...
	cobraCMD.Flags().Bool(ssvMetricPeersFlag, true, "Enable SSV client peers metric")
	cobraCMD.Flags().Bool(ssvMetricConnectionsFlag, true, "Enable SSV client connections metric")
